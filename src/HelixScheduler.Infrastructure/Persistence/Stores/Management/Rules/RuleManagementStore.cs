...
using RuleEntity = HelixScheduler.Infrastructure.Persistence.Entities.Rules;

namespace HelixScheduler.Infrastructure.Persistence.Stores.Management.Rules;
...
public sealed class RuleManagementStore : IRuleManagementStore
{
    ...
    private static RuleManagementDto Map(RuleEntity entity)
    {
